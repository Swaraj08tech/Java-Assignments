...
The user selects an option and provides two numeric inputs.
The program validates the inputs and calls the corresponding modular method.
Results are displayed, and the user can choose to perform another calculation or exit.
